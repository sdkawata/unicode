...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _ucdparser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ucdparser */ \"./src/ucdparser.tsx\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\nconsole.log('worker started');\n(() => __awaiter(void 0, void 0, void 0, function* () {\n    const data = (yield axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/ucd.json')).data;\n    console.log('dict fetched');\n    self.addEventListener('message', function (e) {\n        if (e.data.codepoint) {\n            const parsed = Object(_ucdparser__WEBPACK_IMPORTED_MODULE_1__[\"parseInfo\"])(data, e.data.codepoint);\n            self.postMessage({\n                codepoint: e.data.codepoint,\n                result: parsed,\n            });\n        }\n    });\n}))();\n\n\n//# sourceURL=webpack:///./src/worker.ts?");
